...
// Methods
    ...
    private List<Item> GetChallengeItems() {
        return new List<Item> {
            ...
            new Item("Cigarettes", "Toxic chemicals leach into the water, harming marine life.", 5),
            ...
            new Item("Wrapper", "Contributes to microplastics and is ingested by marine animals.", 8),
        ...
        foreach (var question in questions) {
            ...
            while(!answeredCorrectly){
                ...
                if (question.IsCorrect(inputUser)){
                    ...
                    context.PlayerInventory.AddItem(rewardItem); // Adds rewarditem to inventory
